...
def main():
    ...
    try:
        ...
        try:
            ...
            daily_processed = process_stats_for_visual(daily_stats) if daily_stats.get("team_stats") else []
            weekly_processed = process_stats_for_visual(weekly_stats) if weekly_stats.get("team_stats") else []
            
            # Combined image
            if daily_processed and weekly_processed:
