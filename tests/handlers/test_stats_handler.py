...
@patch("os.open")
@patch("os.close")
def test_stats_handler_execute_sanity(mock_os_close, mock_os_open, mock_exists, mock_popen, mock_messaging_api, mock_api_client, mock_get_pacific, mock_load_meta, mock_load_config):
    handler = StatsHandler()
    ...
    # Execute (this should trigger data update flow)
